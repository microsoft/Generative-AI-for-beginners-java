# Генеративный ИИ для начинающих - версия для Java
[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

![Генеративный ИИ для начинающих - версия для Java](../../translated_images/ru/beg-genai-series.8b48be9951cc574c.webp)

**Временные затраты**: Всю мастерскую можно пройти онлайн без локальной настройки. Настройка окружения занимает 2 минуты, исследование примеров — от 1 до 3 часов в зависимости от глубины изучения.
...
5. Подождите около 2 минут, пока окружение не будет готово
6. Перейдите напрямую к [Глава 2: Provision Azure AI Foundry](./02-SetupDevEnvironment/README.md#step-2-provision-azure-ai-foundry)
...
- **[→ Перейти к Главе 1](./01-IntroToGenAI/README.md)**

### **Глава 2: Настройка среды разработки**
- **Azure AI Foundry**: Предоставление GPT-5.6 Luna chat и текстовых эмбеддингов text-embedding-3-small с использованием Bicep и Azure Developer CLI (azd)
- **Spring Boot 4.1.1 + Spring AI 2.0.1**: Изучение с `ChatClient`, основанным на официальном OpenAI Java SDK и Azure OpenAI v1
...
- **[→ Перейти к Главе 2](./02-SetupDevEnvironment/README.md)**

### **Глава 3: Основные методы генеративного ИИ**
- **Официальный OpenAI Java SDK**: Прямой вызов Azure OpenAI v1 с аутентификацией без ключей
- **Инжиниринг подсказок**: Техники для получения оптимальных ответов от моделей ИИ
- **Эмбеддинги и операции с векторами**: Реализация семантического поиска и поиска по похожести
...
- **[→ Перейти к Главе 3](./03-CoreGenerativeAITechniques/README.md)**

### **Глава 4: Практические приложения и проекты**
- **Генератор историй о питомцах** (`petstory/`): Креативная генерация контента с помощью Azure AI Foundry
- **Демонстрация Foundry локально** (`foundrylocal/`): Локальная интеграция моделей ИИ с OpenAI Java SDK
- **Сервис калькулятора MCP** (`calculator/`): Базовая реализация протокола контекста модели с Spring AI
- **[→ Перейти к Главе 4](./04-PracticalSamples/README.md)**

### **Глава 5: Ответственная разработка ИИ**
- **Безопасность контента Azure AI Foundry**: Тестирование встроенных механизмов фильтрации и безопасности контента (жёсткие блокировки и мягкие отказы)
- **Демонстрация ответственного ИИ**: Практический пример работы современных систем безопасности ИИ
- **Лучшие практики**: Важные рекомендации по этичной разработке и развертыванию ИИ
- **[→ Перейти к Главе 5](./05-ResponsibleGenAI/README.md)**
...
Если вы застряли или у вас есть вопросы по созданию приложений ИИ, присоединяйтесь к другим учащимся и опытным разработчикам для обсуждения MCP. Это поддерживающее сообщество, где приветствуются вопросы и свободно делятся знаниями.
