...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-21T15:18:54+00:00",
...
- Testen und behandeln Sie KI-Sicherheitsantworten mithilfe der integrierten Schutzfunktionen von GitHub Models
...
GitHub Models bietet grundlegende Inhaltsfilterung direkt integriert. Es ist wie ein freundlicher Türsteher in Ihrem KI-Club – nicht der ausgeklügeltste, aber ausreichend für grundlegende Szenarien.
...
4. Bearbeiten der Antworten: entweder generierte Inhalte oder blockierte Inhalte durch Sicherheitsfilter
5. Anzeigen der Ergebnisse, welche Inhalte blockiert und welche zugelassen wurden
6. Testen sicherer Inhalte zum Vergleich

![Demo zur KI-Sicherheit](../../../translated_images/responsible.d11c51f81baaa03084e44a1016936cf77a89971dce9927ec992bf2482d00a944.de.png)
...
Beim Aufbau von KI-Anwendungen sollten Sie folgende wesentliche Praktiken beachten:

1. **Behandeln Sie potenzielle Antworten von Sicherheitsfiltern immer sorgfältig**
...
2. **Implementieren Sie zusätzliche Inhaltsvalidierung, wo erforderlich**
...
Dieses Beispiel verwendet absichtlich problematische Eingaben ausschließlich zu Bildungszwecken. Ziel ist es, Sicherheitsmaßnahmen zu demonstrieren, nicht sie zu umgehen. Nutzen Sie KI-Tools immer verantwortungsvoll und ethisch.
...
- Aufbau praktischer KI-Anwendungen
