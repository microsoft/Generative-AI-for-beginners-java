...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-25T10:38:42+00:00",
...
Dieses Tutorial bietet praxisnahe Beispiele für grundlegende Techniken der generativen KI mit Java und GitHub Models. Sie lernen, wie Sie mit Large Language Models (LLMs) interagieren, Funktionsaufrufe implementieren, Retrieval-Augmented Generation (RAG) nutzen und verantwortungsvolle KI-Praktiken anwenden.
...
Dies stellt eine Verbindung zu GitHub Models mit Ihrem Token her.
...
2. **Mehrstufiger Chat**: Die KI behält den Kontext über mehrere Fragen hinweg.
...
Funktionsaufrufe ermöglichen es KI-Modellen, externe Tools und APIs über ein strukturiertes Protokoll anzufordern. Das Modell analysiert natürliche Sprachbefehle, bestimmt die erforderlichen Funktionsaufrufe mit passenden Parametern anhand von JSON-Schema-Definitionen und verarbeitet die zurückgegebenen Ergebnisse, um kontextbezogene Antworten zu generieren. Die tatsächliche Funktionsausführung bleibt dabei unter der Kontrolle des Entwicklers, um Sicherheit und Zuverlässigkeit zu gewährleisten.
...
Das Beispiel zur verantwortungsvollen KI zeigt die Bedeutung von Sicherheitsmaßnahmen in KI-Anwendungen. Es demonstriert Sicherheitsfilter, die schädliche Inhaltskategorien wie Hassrede, Belästigung, Selbstverletzung, sexuelle Inhalte und Gewalt erkennen. Es wird gezeigt, wie produktive KI-Anwendungen Verstöße gegen Inhaltsrichtlinien durch geeignete Fehlerbehandlung, Benutzerfeedback-Mechanismen und alternative Antwortstrategien elegant handhaben sollten.
