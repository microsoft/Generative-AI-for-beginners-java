...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-21T15:22:45+00:00",
...
4. **Fehlerbehandlung**: Bietet Ersatzgeschichten, wenn der KI-Service ausfällt
5. **Modellbindung**: Übergibt Daten an HTML-Templates mit Spring's `Model`

**Fallback-System:**
Der Controller enthält vorgefertigte Story-Templates, die verwendet werden, wenn der KI-Service nicht verfügbar ist:
...
### Schritt 1: GitHub-Token festlegen

Zuerst müssen Sie Ihr GitHub-Token als Umgebungsvariable festlegen:
...
5. **Sehen** Sie sich die kreative Geschichte basierend auf der Beschreibung Ihres Haustiers an
...
Falls der KI-Service ausfällt:
1. Der Controller fängt die Ausnahme ab
2. Generiert eine Ersatzgeschichte mit vorgefertigten Templates
