...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-29T15:48:18+00:00",
...
**זמן נדרש**: ניתן להשלים את הסדנה כולה באופן מקוון ללא צורך בהתקנה מקומית. הגדרת הסביבה אורכת כ-2 דקות, וההתנסות בדוגמאות דורשת בין שעה לשלוש שעות, בהתאם לעומק החקירה.
...
- **מודלים של GitHub**: גישה חינמית למודלי AI לצורך אבטיפוס ולמידה (ללא צורך בכרטיס אשראי)  
