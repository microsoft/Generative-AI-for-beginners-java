...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-29T14:23:45+00:00",
...
- [البدء](../../../03-CoreGenerativeAITechniques)
  - [الخطوة 1: ضبط متغير البيئة الخاص بك](../../../03-CoreGenerativeAITechniques)
...
يوفر هذا الدليل أمثلة عملية على تقنيات الذكاء الاصطناعي التوليدي الأساسية باستخدام Java ونماذج GitHub. ستتعلم كيفية التفاعل مع النماذج اللغوية الكبيرة (LLMs)، وتنفيذ استدعاء الوظائف، واستخدام التوليد المعزز بالاسترجاع (RAG)، وتطبيق ممارسات الذكاء الاصطناعي المسؤول.
...
### الخطوة 1: ضبط متغير البيئة الخاص بك
...
1. **الإكمال البسيط**: يجيب الذكاء الاصطناعي على سؤال Java مع توجيه من النظام
...
يتيح استدعاء الوظائف للنماذج الذكاء الاصطناعي طلب تنفيذ أدوات وواجهات برمجية خارجية من خلال بروتوكول منظم حيث يقوم النموذج بتحليل الطلبات الطبيعية، وتحديد استدعاءات الوظائف المطلوبة مع المعلمات المناسبة باستخدام تعريفات JSON Schema، ومعالجة النتائج المسترجعة لتوليد استجابات سياقية، بينما يظل تنفيذ الوظائف الفعلي تحت سيطرة المطور لضمان الأمان والموثوقية.
...
يوضح مثال الذكاء الاصطناعي المسؤول أهمية تنفيذ تدابير السلامة في تطبيقات الذكاء الاصطناعي. يوضح كيف تعمل أنظمة السلامة الحديثة للذكاء الاصطناعي من خلال آليتين رئيسيتين: الحظر الصارم (أخطاء HTTP 400 من مرشحات السلامة) والرفض الناعم (ردود مهذبة مثل "لا يمكنني مساعدتك في ذلك" من النموذج نفسه). يوضح هذا المثال كيف يجب أن تتعامل تطبيقات الذكاء الاصطناعي الإنتاجية مع انتهاكات سياسة المحتوى من خلال معالجة الاستثناءات بشكل صحيح، واكتشاف الرفض، وآليات ملاحظات المستخدم، واستراتيجيات الاستجابة البديلة.
...
يختبر البرنامج مطالبات ضارة مختلفة ويظهر كيف يعمل نظام السلامة للذكاء الاصطناعي من خلال آليتين:

1. **الحظر الصارم**: أخطاء HTTP 400 عندما يتم حظر المحتوى بواسطة مرشحات السلامة قبل الوصول إلى النموذج
2. **الرفض الناعم**: يرد النموذج برفض مهذب مثل "لا يمكنني مساعدتك في ذلك" (الأكثر شيوعًا مع النماذج الحديثة)
3. **المحتوى الآمن**: يسمح بإنشاء الطلبات المشروعة بشكل طبيعي
...
هذا يوضح أن **كل من الحظر الصارم والرفض الناعم يشيران إلى أن نظام السلامة يعمل بشكل صحيح**.
...
هل أنت مستعد لتطبيق هذه التقنيات؟ لنبدأ ببناء تطبيقات حقيقية!
