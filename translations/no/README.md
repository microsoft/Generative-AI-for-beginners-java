...
![Generativ AI for Nybegynnere - Java Edition](../../translated_images/no/beg-genai-series.8b48be9951cc574c.webp)

**Tidsbruk**: Hele workshopen kan fullføres på nettet uten lokal oppsett. Miljøoppsettet tar 2 minutter, mens utforsking av eksemplene tar 1-3 timer avhengig av hvor grundig du ønsker å utforske.

> **Rask start** 

1. Fork dette depotet til din GitHub-konto
2. Klikk **Code** → **Codespaces** fanen → **...** → **Ny med alternativer...**
...
6. Gå direkte til [Kapittel 2: Provisjoner Azure AI Foundry](./02-SetupDevEnvironment/README.md#step-2-provision-azure-ai-foundry)
...
## Kursstruktur & Læringsvei

### **Kapittel 1: Introduksjon til Generativ AI**
- **Kjernebegreper**: Forståelse av store språkmodeller, tokens, embeddings og AI-funksjonalitet
...
- **Praktiske anvendelser**: Reelle scenarioer inkludert chatboter og innholdsgenerering
- **[→ Start Kapittel 1](./01-IntroToGenAI/README.md)**

### **Kapittel 2: Utviklingsmiljøoppsett**
- **Azure AI Foundry**: Provisioner GPT-5.6 Luna chat og text-embedding-3-small embeddings med Bicep og Azure Developer CLI (azd)
- **Spring Boot 4.1.1 + Spring AI 2.0.1**: Lær med `ChatClient`, støttet av den offisielle OpenAI Java SDK og Azure OpenAI v1
- **Nøkkelfri autentisering**: Koble sikkert med Microsoft Entra ID — ingen API-nøkler å håndtere
...
- **Offisiell OpenAI Java SDK**: Kall Azure OpenAI v1 direkte med nøkkelfri autentisering
- **Prompt Engineering**: Teknikker for optimale AI-modell-svar
...
- **Funksjonskall**: Utvid AI-funksjonalitet med tilpassede verktøy og plugins
...
- **Azure AI Foundry innholdssikkerhet**: Test innebygde innholdsfiltre og sikkerhetsmekanismer (harde blokker og myke avslag)
...
Hvis du har produktinnspill eller finner feil under bygging, besøk:
