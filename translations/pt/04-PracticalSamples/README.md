...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-25T11:19:53+00:00",
...
O **[Demo Foundry Local Spring Boot](foundrylocal/README.md)** demonstra como integrar modelos de IA locais utilizando o **OpenAI Java SDK**. Mostra a conexão com o modelo **Phi-3.5-mini** a correr no Foundry Local, permitindo executar aplicações de IA sem depender de serviços na nuvem.
