...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-25T11:08:50+00:00",
...
## আপনি কী শিখবেন
এই অধ্যায়ে আমরা তিনটি ব্যবহারিক প্রয়োগের ডেমো দেখাবো, যা Java-র মাধ্যমে জেনারেটিভ AI ডেভেলপমেন্ট প্যাটার্ন প্রদর্শন করে:
...
এই অধ্যায়ে **নমুনা প্রকল্প** উপস্থাপন করা হয়েছে, যা Java-র মাধ্যমে জেনারেটিভ AI ডেভেলপমেন্ট প্যাটার্ন প্রদর্শন করে। প্রতিটি প্রকল্প সম্পূর্ণ কার্যকর এবং নির্দিষ্ট AI প্রযুক্তি, আর্কিটেকচারাল প্যাটার্ন এবং সেরা অনুশীলনগুলো প্রদর্শন করে, যা আপনি আপনার নিজস্ব অ্যাপ্লিকেশনে প্রয়োগ করতে পারেন।
...
**[Pet Story Generator](petstory/README.md)** একটি আকর্ষণীয় Spring Boot ওয়েব অ্যাপ্লিকেশন, যা **মাল্টি-মোডাল AI প্রসেসিং** প্রদর্শন করে সৃজনশীল পোষা প্রাণীর গল্প তৈরি করতে। এটি ব্রাউজার-ভিত্তিক AI ইন্টারঅ্যাকশন এর জন্য transformer.js এবং সার্ভার-সাইড প্রসেসিং এর জন্য OpenAI SDK ব্যবহার করে ক্লায়েন্ট-সাইড এবং সার্ভার-সাইড AI ক্ষমতা একত্রিত করে।

### MCP Calculator Service (শুরুর MCP ডেমো)

**[MCP Calculator Service](mcp/calculator/README.md)** Spring AI ব্যবহার করে **Model Context Protocol (MCP)** এর একটি সহজ ডেমো। এটি MCP ধারণার একটি প্রাথমিক পরিচিতি প্রদান করে, যেখানে একটি মৌলিক MCP সার্ভার তৈরি করা হয় যা MCP ক্লায়েন্টের সাথে ইন্টারঅ্যাক্ট করে।

## শেখার অগ্রগতি

এই প্রকল্পগুলো পূর্ববর্তী অধ্যায়ের ধারণাগুলোর উপর ভিত্তি করে তৈরি করা হয়েছে:

1. **সহজ থেকে শুরু করুন**: Foundry Local Spring Boot Demo দিয়ে শুরু করুন, লোকাল মডেলের সাথে AI ইন্টিগ্রেশনের মৌলিক বিষয়গুলো বুঝতে
2. **ইন্টারঅ্যাক্টিভিটি যোগ করুন**: Pet Story Generator-এ অগ্রসর হন মাল্টি-মোডাল AI এবং ওয়েব-ভিত্তিক ইন্টারঅ্যাকশন এর জন্য
3. **MCP এর মৌলিক বিষয় শিখুন**: MCP Calculator Service চেষ্টা করুন Model Context Protocol এর ভিত্তি বুঝতে
