...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-29T15:26:14+00:00",
...
- **Την εφαρμογή μέτρων ασφάλειας ΤΝ**, συμπεριλαμβανομένου του φιλτραρίσματος περιεχομένου και της διαχείρισης απαντήσεων ασφαλείας
